  ...
  return (
    <main className={`${isDarkMode ? "dark" : ""} relative`}>
      <div className="absolute w-full h-screen -z-20">
        ...
        <div className="absolute rounded-full bg-color-second dark:bg-darkmode-color-second transition-colors duration-300 w-28 h-28 top-40 right-28"></div>
      ...
      <div className="absolute w-full h-full bg-transparent -z-10 backdrop-blur-2xl"></div>
